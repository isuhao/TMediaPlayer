...
bool CDiscInfos::hasDiscInDrive()
{
    if (m_device == INVALID_HANDLE_VALUE)
    {
        m_device = CreateFileA(qPrintable(m_deviceName), GENERIC_READ, FILE_SHARE_READ | FILE_SHARE_WRITE, nullptr, OPEN_EXISTING, 0, nullptr);
        ...
        DWORD dwReturned;
        BOOL bResult = DeviceIoControl(m_device, IOCTL_CDROM_GET_LAST_SESSION, nullptr, 0, &session, sizeof(session), &dwReturned, nullptr);
    ...
    else
    {
        ...
        BOOL bResult = DeviceIoControl(m_device, IOCTL_STORAGE_CHECK_VERIFY2, nullptr, 0, nullptr, 0, &cbBytesReturned, nullptr);
...
bool CDiscInfos::readInfos()
{
    ...
    CDROM_TOC toc;
    bResult = DeviceIoControl(m_device, IOCTL_CDROM_READ_TOC, nullptr, 0, &toc, sizeof(toc), &dwReturned, nullptr);
...
void CDiscInfos::ejectDisc()
{
    ...
    DWORD cbBytesReturned;
    BOOL bResult = DeviceIoControl(m_device, IOCTL_STORAGE_EJECT_MEDIA, nullptr, 0, nullptr, 0, &cbBytesReturned, nullptr);
}
