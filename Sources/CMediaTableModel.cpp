...
void CMediaTableModel::sort(int column, Qt::SortOrder order)
{
    ...
    if (order == Qt::AscendingOrder)
    {
        switch (column)
        {
            case CMediaTableView::ColPosition        : qSort(m_data.begin(), m_data.end(), cmpSongPositionAsc        ); break;
            case CMediaTableView::ColTitle           : qSort(m_data.begin(), m_data.end(), cmpSongTitleAsc           ); break;
            case CMediaTableView::ColArtist          : qSort(m_data.begin(), m_data.end(), cmpSongArtistAsc          ); break;
            case CMediaTableView::ColAlbum           : qSort(m_data.begin(), m_data.end(), cmpSongAlbumAsc           ); break;
            case CMediaTableView::ColAlbumArtist     : qSort(m_data.begin(), m_data.end(), cmpSongAlbumArtistAsc     ); break;
            case CMediaTableView::ColComposer        : qSort(m_data.begin(), m_data.end(), cmpSongComposerAsc        ); break;
            case CMediaTableView::ColYear            : qSort(m_data.begin(), m_data.end(), cmpSongYearAsc            ); break;
            case CMediaTableView::ColTrackNumber     : qSort(m_data.begin(), m_data.end(), cmpSongTrackAsc           ); break;
            case CMediaTableView::ColDiscNumber      : qSort(m_data.begin(), m_data.end(), cmpSongDiscAsc            ); break;
            case CMediaTableView::ColGenre           : qSort(m_data.begin(), m_data.end(), cmpSongGenreAsc           ); break;
            case CMediaTableView::ColRating          : qSort(m_data.begin(), m_data.end(), cmpSongRatingAsc          ); break;
            case CMediaTableView::ColComments        : qSort(m_data.begin(), m_data.end(), cmpSongCommentsAsc        ); break;
            case CMediaTableView::ColPlayCount       : qSort(m_data.begin(), m_data.end(), cmpSongPlayCountAsc       ); break;
            case CMediaTableView::ColLastPlayTime    : qSort(m_data.begin(), m_data.end(), cmpSongLastPlayedAsc      ); break;
            case CMediaTableView::ColPathName        : qSort(m_data.begin(), m_data.end(), cmpSongPathNameAsc        ); break;
            case CMediaTableView::ColBitRate         : qSort(m_data.begin(), m_data.end(), cmpSongBitRateAsc         ); break;
            case CMediaTableView::ColFormat          : qSort(m_data.begin(), m_data.end(), cmpSongFormatAsc          ); break;
            case CMediaTableView::ColDuration        : qSort(m_data.begin(), m_data.end(), cmpSongDurationAsc        ); break;
            case CMediaTableView::ColSampleRate      : qSort(m_data.begin(), m_data.end(), cmpSongSampleRateAsc      ); break;
            case CMediaTableView::ColCreationDate    : qSort(m_data.begin(), m_data.end(), cmpSongCreationDateAsc    ); break;
            case CMediaTableView::ColModificationDate: qSort(m_data.begin(), m_data.end(), cmpSongModificationDateAsc); break;
            case CMediaTableView::ColChannels        : qSort(m_data.begin(), m_data.end(), cmpSongChannelsAsc        ); break;
            case CMediaTableView::ColFileSize        : qSort(m_data.begin(), m_data.end(), cmpSongFileSizeAsc        ); break;
            case CMediaTableView::ColLyrics          : qSort(m_data.begin(), m_data.end(), cmpSongLyricsAsc          ); break;
            case CMediaTableView::ColLanguage        : qSort(m_data.begin(), m_data.end(), cmpSongLanguageAsc        ); break;
            case CMediaTableView::ColLyricist        : qSort(m_data.begin(), m_data.end(), cmpSongLyricistAsc        ); break;
            case CMediaTableView::ColGrouping        : qSort(m_data.begin(), m_data.end(), cmpSongGroupingAsc        ); break;
            case CMediaTableView::ColSubTitle        : qSort(m_data.begin(), m_data.end(), cmpSongSubTitleAsc        ); break;
            case CMediaTableView::ColTrackGain       : qSort(m_data.begin(), m_data.end(), cmpSongTrackGainAsc       ); break;
            case CMediaTableView::ColTrackPeak       : qSort(m_data.begin(), m_data.end(), cmpSongTrackPeakAsc       ); break;
            case CMediaTableView::ColAlbumGain       : qSort(m_data.begin(), m_data.end(), cmpSongAlbumGainAsc       ); break;
            case CMediaTableView::ColAlbumPeak       : qSort(m_data.begin(), m_data.end(), cmpSongAlbumPeakAsc       ); break;
            case CMediaTableView::ColBPM             : qSort(m_data.begin(), m_data.end(), cmpSongBPMAsc             ); break;
            case CMediaTableView::ColTitleSort       : qSort(m_data.begin(), m_data.end(), cmpSongTitleSortAsc       ); break;
            case CMediaTableView::ColArtistSort      : qSort(m_data.begin(), m_data.end(), cmpSongArtistSortAsc      ); break;
            case CMediaTableView::ColAlbumSort       : qSort(m_data.begin(), m_data.end(), cmpSongAlbumSortAsc       ); break;
            case CMediaTableView::ColAlbumArtistSort : qSort(m_data.begin(), m_data.end(), cmpSongAlbumArtistSortAsc ); break;
            case CMediaTableView::ColComposerSort    : qSort(m_data.begin(), m_data.end(), cmpSongComposerSortAsc    ); break;
            case CMediaTableView::ColFileName        : qSort(m_data.begin(), m_data.end(), cmpSongFileNameAsc        ); break;
        }
    }
    else
    {
        switch (column)
        {
            case CMediaTableView::ColPosition        : qSort(m_data.begin(), m_data.end(), cmpSongPositionDesc        ); break;
            case CMediaTableView::ColTitle           : qSort(m_data.begin(), m_data.end(), cmpSongTitleDesc           ); break;
            case CMediaTableView::ColArtist          : qSort(m_data.begin(), m_data.end(), cmpSongArtistDesc          ); break;
            case CMediaTableView::ColAlbum           : qSort(m_data.begin(), m_data.end(), cmpSongAlbumDesc           ); break;
            case CMediaTableView::ColAlbumArtist     : qSort(m_data.begin(), m_data.end(), cmpSongAlbumArtistDesc     ); break;
            case CMediaTableView::ColComposer        : qSort(m_data.begin(), m_data.end(), cmpSongComposerDesc        ); break;
            case CMediaTableView::ColYear            : qSort(m_data.begin(), m_data.end(), cmpSongYearDesc            ); break;
            case CMediaTableView::ColTrackNumber     : qSort(m_data.begin(), m_data.end(), cmpSongTrackDesc           ); break;
            case CMediaTableView::ColDiscNumber      : qSort(m_data.begin(), m_data.end(), cmpSongDiscDesc            ); break;
            case CMediaTableView::ColGenre           : qSort(m_data.begin(), m_data.end(), cmpSongGenreDesc           ); break;
            case CMediaTableView::ColRating          : qSort(m_data.begin(), m_data.end(), cmpSongRatingDesc          ); break;
            case CMediaTableView::ColComments        : qSort(m_data.begin(), m_data.end(), cmpSongCommentsDesc        ); break;
            case CMediaTableView::ColPlayCount       : qSort(m_data.begin(), m_data.end(), cmpSongPlayCountDesc       ); break;
            case CMediaTableView::ColLastPlayTime    : qSort(m_data.begin(), m_data.end(), cmpSongLastPlayedDesc      ); break;
            case CMediaTableView::ColPathName        : qSort(m_data.begin(), m_data.end(), cmpSongPathNameDesc        ); break;
            case CMediaTableView::ColBitRate         : qSort(m_data.begin(), m_data.end(), cmpSongBitRateDesc         ); break;
            case CMediaTableView::ColFormat          : qSort(m_data.begin(), m_data.end(), cmpSongFormatDesc          ); break;
            case CMediaTableView::ColDuration        : qSort(m_data.begin(), m_data.end(), cmpSongDurationDesc        ); break;
            case CMediaTableView::ColSampleRate      : qSort(m_data.begin(), m_data.end(), cmpSongSampleRateDesc      ); break;
            case CMediaTableView::ColCreationDate    : qSort(m_data.begin(), m_data.end(), cmpSongCreationDateDesc    ); break;
            case CMediaTableView::ColModificationDate: qSort(m_data.begin(), m_data.end(), cmpSongModificationDateDesc); break;
            case CMediaTableView::ColChannels        : qSort(m_data.begin(), m_data.end(), cmpSongChannelsDesc        ); break;
            case CMediaTableView::ColFileSize        : qSort(m_data.begin(), m_data.end(), cmpSongFileSizeDesc        ); break;
            case CMediaTableView::ColLyrics          : qSort(m_data.begin(), m_data.end(), cmpSongLyricsDesc          ); break;
            case CMediaTableView::ColLanguage        : qSort(m_data.begin(), m_data.end(), cmpSongLanguageDesc        ); break;
            case CMediaTableView::ColLyricist        : qSort(m_data.begin(), m_data.end(), cmpSongLyricistDesc        ); break;
            case CMediaTableView::ColGrouping        : qSort(m_data.begin(), m_data.end(), cmpSongGroupingDesc        ); break;
            case CMediaTableView::ColSubTitle        : qSort(m_data.begin(), m_data.end(), cmpSongSubTitleDesc        ); break;
            case CMediaTableView::ColTrackGain       : qSort(m_data.begin(), m_data.end(), cmpSongTrackGainDesc       ); break;
            case CMediaTableView::ColTrackPeak       : qSort(m_data.begin(), m_data.end(), cmpSongTrackPeakDesc       ); break;
            case CMediaTableView::ColAlbumGain       : qSort(m_data.begin(), m_data.end(), cmpSongAlbumGainDesc       ); break;
            case CMediaTableView::ColAlbumPeak       : qSort(m_data.begin(), m_data.end(), cmpSongAlbumPeakDesc       ); break;
            case CMediaTableView::ColBPM             : qSort(m_data.begin(), m_data.end(), cmpSongBPMDesc             ); break;
            case CMediaTableView::ColTitleSort       : qSort(m_data.begin(), m_data.end(), cmpSongTitleSortDesc       ); break;
            case CMediaTableView::ColArtistSort      : qSort(m_data.begin(), m_data.end(), cmpSongArtistSortDesc      ); break;
            case CMediaTableView::ColAlbumSort       : qSort(m_data.begin(), m_data.end(), cmpSongAlbumSortDesc       ); break;
            case CMediaTableView::ColAlbumArtistSort : qSort(m_data.begin(), m_data.end(), cmpSongAlbumArtistSortDesc ); break;
            case CMediaTableView::ColComposerSort    : qSort(m_data.begin(), m_data.end(), cmpSongComposerSortDesc    ); break;
            case CMediaTableView::ColFileName        : qSort(m_data.begin(), m_data.end(), cmpSongFileNameDesc        ); break;
        }
    }
    ...
    if (order == Qt::AscendingOrder)
    {
        switch (column)
        {
            case CMediaTableView::ColPosition        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongPositionAsc        ); break;
            case CMediaTableView::ColTitle           : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongTitleAsc           ); break;
            case CMediaTableView::ColArtist          : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongArtistAsc          ); break;
            case CMediaTableView::ColAlbum           : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongAlbumAsc           ); break;
            case CMediaTableView::ColAlbumArtist     : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongAlbumArtistAsc     ); break;
            case CMediaTableView::ColComposer        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongComposerAsc        ); break;
            case CMediaTableView::ColYear            : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongYearAsc            ); break;
            case CMediaTableView::ColTrackNumber     : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongTrackAsc           ); break;
            case CMediaTableView::ColDiscNumber      : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongDiscAsc            ); break;
            case CMediaTableView::ColGenre           : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongGenreAsc           ); break;
            case CMediaTableView::ColRating          : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongRatingAsc          ); break;
            case CMediaTableView::ColComments        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongCommentsAsc        ); break;
            case CMediaTableView::ColPlayCount       : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongPlayCountAsc       ); break;
            case CMediaTableView::ColLastPlayTime    : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongLastPlayedAsc      ); break;
            case CMediaTableView::ColPathName        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongFileNameAsc        ); break;
            case CMediaTableView::ColBitRate         : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongBitRateAsc         ); break;
            case CMediaTableView::ColFormat          : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongFormatAsc          ); break;
            case CMediaTableView::ColDuration        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongDurationAsc        ); break;
            case CMediaTableView::ColSampleRate      : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongSampleRateAsc      ); break;
            case CMediaTableView::ColCreationDate    : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongCreationDateAsc    ); break;
            case CMediaTableView::ColModificationDate: qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongModificationDateAsc); break;
            case CMediaTableView::ColChannels        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongChannelsAsc        ); break;
            case CMediaTableView::ColFileSize        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongFileSizeAsc        ); break;
            case CMediaTableView::ColLyrics          : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongLyricsAsc          ); break;
            case CMediaTableView::ColLanguage        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongLanguageAsc        ); break;
            case CMediaTableView::ColLyricist        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongLyricistAsc        ); break;
            case CMediaTableView::ColGrouping        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongGroupingAsc        ); break;
            case CMediaTableView::ColSubTitle        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongSubTitleAsc        ); break;
            case CMediaTableView::ColTrackGain       : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongTrackGainAsc       ); break;
            case CMediaTableView::ColTrackPeak       : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongTrackPeakAsc       ); break;
            case CMediaTableView::ColAlbumGain       : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongAlbumGainAsc       ); break;
            case CMediaTableView::ColAlbumPeak       : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongAlbumPeakAsc       ); break;
            case CMediaTableView::ColBPM             : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongBPMAsc             ); break;
            case CMediaTableView::ColTitleSort       : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongTitleSortAsc       ); break;
            case CMediaTableView::ColArtistSort      : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongArtistSortAsc      ); break;
            case CMediaTableView::ColAlbumSort       : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongAlbumSortAsc       ); break;
            case CMediaTableView::ColAlbumArtistSort : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongAlbumArtistSortAsc ); break;
            case CMediaTableView::ColComposerSort    : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongComposerSortAsc    ); break;
            case CMediaTableView::ColFileName        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongFileNameAsc        ); break;
        }
    }
    else
    {
        switch (column)
        {
            case CMediaTableView::ColPosition        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongPositionDesc        ); break;
            case CMediaTableView::ColTitle           : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongTitleDesc           ); break;
            case CMediaTableView::ColArtist          : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongArtistDesc          ); break;
            case CMediaTableView::ColAlbum           : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongAlbumDesc           ); break;
            case CMediaTableView::ColAlbumArtist     : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongAlbumArtistDesc     ); break;
            case CMediaTableView::ColComposer        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongComposerDesc        ); break;
            case CMediaTableView::ColYear            : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongYearDesc            ); break;
            case CMediaTableView::ColTrackNumber     : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongTrackDesc           ); break;
            case CMediaTableView::ColDiscNumber      : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongDiscDesc            ); break;
            case CMediaTableView::ColGenre           : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongGenreDesc           ); break;
            case CMediaTableView::ColRating          : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongRatingDesc          ); break;
            case CMediaTableView::ColComments        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongCommentsDesc        ); break;
            case CMediaTableView::ColPlayCount       : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongPlayCountDesc       ); break;
            case CMediaTableView::ColLastPlayTime    : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongLastPlayedDesc      ); break;
            case CMediaTableView::ColPathName        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongFileNameDesc        ); break;
            case CMediaTableView::ColBitRate         : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongBitRateDesc         ); break;
            case CMediaTableView::ColFormat          : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongFormatDesc          ); break;
            case CMediaTableView::ColDuration        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongDurationDesc        ); break;
            case CMediaTableView::ColSampleRate      : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongSampleRateDesc      ); break;
            case CMediaTableView::ColCreationDate    : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongCreationDateDesc    ); break;
            case CMediaTableView::ColModificationDate: qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongModificationDateDesc); break;
            case CMediaTableView::ColChannels        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongChannelsDesc        ); break;
            case CMediaTableView::ColFileSize        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongFileSizeDesc        ); break;
            case CMediaTableView::ColLyrics          : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongLyricsDesc          ); break;
            case CMediaTableView::ColLanguage        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongLanguageDesc        ); break;
            case CMediaTableView::ColLyricist        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongLyricistDesc        ); break;
            case CMediaTableView::ColGrouping        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongGroupingDesc        ); break;
            case CMediaTableView::ColSubTitle        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongSubTitleDesc        ); break;
            case CMediaTableView::ColTrackGain       : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongTrackGainDesc       ); break;
            case CMediaTableView::ColTrackPeak       : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongTrackPeakDesc       ); break;
            case CMediaTableView::ColAlbumGain       : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongAlbumGainDesc       ); break;
            case CMediaTableView::ColAlbumPeak       : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongAlbumPeakDesc       ); break;
            case CMediaTableView::ColBPM             : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongBPMDesc             ); break;
            case CMediaTableView::ColTitleSort       : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongTitleSortDesc       ); break;
            case CMediaTableView::ColArtistSort      : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongArtistSortDesc      ); break;
            case CMediaTableView::ColAlbumSort       : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongAlbumSortDesc       ); break;
            case CMediaTableView::ColAlbumArtistSort : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongAlbumArtistSortDesc ); break;
            case CMediaTableView::ColComposerSort    : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongComposerSortDesc    ); break;
            case CMediaTableView::ColFileName        : qSort(m_dataFiltered.begin(), m_dataFiltered.end(), cmpSongFileNameDesc        ); break;
        }
    }
