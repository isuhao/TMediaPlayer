...
public:
    ...
    CScrobble(CMediaManager * mediaManager, const QByteArray& sessionKey, CSong * song);
    CScrobble(CMediaManager * mediaManager, const QByteArray& sessionKey, const TScrobbleInfos& song);
