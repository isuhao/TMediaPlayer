...
public:
    ...
    CScrobble(CMainWindow * mainWindow, const QByteArray& sessionKey, CSong * song);
    CScrobble(CMainWindow * mainWindow, const QByteArray& sessionKey, const TScrobbleInfos& song);
